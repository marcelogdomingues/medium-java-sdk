...
public interface PlatformApi {
   ...
   * @return OK (status code 200)
   */
  @Operation(operationId = "recommendedFeedTagGet", summary = "Get Recommended Feed", description = "Returns a list of recommended articles (`article_ids`) for the given `tag`.  This feed is similar to Topfeeds Trending Articles. Using the `page` query string parameter, you can get the list page by page.  The page number can be between 1 and 20. Each page will have up to 25 Article IDs. So at maximum, you can fetch 500 `article_ids` in 20 API calls. ", tags = {
      "Platform"}, responses = {@ApiResponse(responseCode = "200", description = "OK", content = {
   ...
   * @return OK (status code 200)
   */
  @Operation(operationId = "relatedTagsTagGet", summary = "Get Related Tags", description = "Returns a list of `related_tags` for the given `tag`. ", tags = {
      "Platform"}, responses = {@ApiResponse(responseCode = "200", description = "OK", content = {
   ...
   * @return OK (status code 200)
   */
  @Operation(operationId = "tagTagGet", summary = "Get Tag Info", description = "Returns tag-related information. - Name - Followers Count - Number of stories - Number of writers - Number of latest stories - Number of latest writers ", tags = {
      "Platform"}, responses = {@ApiResponse(responseCode = "200", description = "OK", content = {
   ...
   * @return OK (status code 200)
   */
  @Operation(operationId = "topWritersTopicSlugGet", summary = "Get Top Writers", description = "Returns a list of top writers (`user_ids`) within a particular topic/niche (`topic_slug`).  e.g.  - blockchain - relationships - artificial-intelligence, etc ... **Note:** You can use optional `count` query parameter to limit the number of results.  The maximum number of top writers within a topic/niche will be 250. ", tags = {
      "Platform"}, responses = {@ApiResponse(responseCode = "200", description = "OK", content = {
   ...
   * @return OK (status code 200)
   */
  @Operation(operationId = "topfeedsTagModeGet", summary = "Get Topfeeds", description = "Returns a list of `article_ids` (length: 25) for the given `tag` and `mode`. ", tags = {
      "Platform"}, responses = {@ApiResponse(responseCode = "200", description = "OK", content = {

...
public interface PlatformApiClient {
  ...
  /**
   * GET /latestposts/{topic_slug} : Get Latest Posts Returns a list of latest
   * posts (&#x60;article_ids&#x60;) for a topic/niche (as classified by the
   * Medium platform). Example of a topic/niche can be: * blockchain *
   * relationships * mental-health, etc … These are known as
   * &#x60;topic_slugs&#x60;. At any given moment, this endpoint will return a
   * list of 25 articles (&#x60;article_ids&#x60;).
   *
   * @param topicSlug
   *            It&#39;s a unique string, usually hyphen-separated, representing a
   *            topic/niche, as classified by Medium. (required)
  ...
  /**
   * GET /recommended_feed/{tag} : Get Recommended Feed Returns a list of
   * recommended articles (&#x60;article_ids&#x60;) for the given &#x60;tag&#x60;.
   * This feed is similar to Topfeeds Trending Articles. Using the
   * &#x60;page&#x60; query string parameter, you can get the list page by page.
   * The page number can be between 1 and 20. Each page will have up to 25 Article
   * IDs. So at maximum, you can fetch 500 &#x60;article_ids&#x60; in 20 API
   * calls.
   *
   * @param tag
   *            It&#39;s a unique string, usually hyphen-separated, representing a
   *            class of content. (required)
   * @param page
   *            A number between 1 and 20. (optional)
   * @return OK (status code 200)
  ...
  /**
   * GET /related_tags/{tag} : Get Related Tags Returns a list of
   * &#x60;related_tags&#x60; for the given &#x60;tag&#x60;.
   *
   * @param tag
   *            It&#39;s a unique string, usually hyphen-separated, representing a
   *            class of content. (required)
  ...
  /**
   * GET /tag/{tag} : Get Tag Info Returns tag-related information. - Name -
   * Followers Count - Number of stories - Number of writers - Number of latest
   * stories - Number of latest writers
   *
   * @param tag
   *            It&#39;s a unique string, usually hyphen-separated, representing a
   *            class of content. (required)
  ...
  /**
   * GET /top_writers/{topic_slug} : Get Top Writers Returns a list of top writers
   * (&#x60;user_ids&#x60;) within a particular topic/niche
   * (&#x60;topic_slug&#x60;). e.g. - blockchain - relationships -
   * artificial-intelligence, etc ... **Note:** You can use optional
   * &#x60;count&#x60; query parameter to limit the number of results. The maximum
   * number of top writers within a topic/niche will be 250.
   *
   * @param topicSlug
   *            It&#39;s a unique string, usually hyphen-separated, representing a
   *            topic/niche, as classified by Medium. (required)
  ...
  /**
   * GET /topfeeds/{tag}/{mode} : Get Topfeeds Returns a list of
   * &#x60;article_ids&#x60; (length: 25) for the given &#x60;tag&#x60; and
   * &#x60;mode&#x60;.
   *
   * @param tag
   *            It&#39;s a unique string, usually hyphen-separated, representing a
